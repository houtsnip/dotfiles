...
let s:N1   = [ '#00005f' , '#ffff00' , 17  , 11 ]
let s:N2   = [ '#ffffff' , '#808080' , 15  , 8  ]
let s:N3   = [ '#9cffd3' , '#202020' , 17  , 11 ]
let g:airline#themes#mytheme#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)

" Here we define overrides for when the buffer is modified.  This will be
" applied after g:airline#themes#mytheme#palette.normal, hence why only certain keys are
" declared.
...
let s:I1 = [ '#00005f' , '#00dfff' , 17  , 14  ]
let s:I2 = [ '#ffffff' , '#005fff' , 15  , 8   ]
let s:I3 = [ '#ffffff' , '#000080' , 17  , 14  ]
...
"      \ }
let g:airline#themes#mytheme#palette.insert_paste = {
      \ 'airline_a': [ s:I1[0]   , '#d78700' , s:I1[2] , 2     , ''     ] ,
      \ }


let g:airline#themes#mytheme#palette.replace = copy(g:airline#themes#mytheme#palette.insert)
"let g:airline#themes#mytheme#palette.replace.airline_a = [ s:I2[0]   , '#af0000' , s:I2[2] , 124     , ''     ]
let g:airline#themes#mytheme#palette.replace.airline_a = [ s:I2[0]   , '#af0000' , s:I2[2] , 9     , ''     ]
...
let g:airline#themes#mytheme#palette.inactive = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)
...
let g:airline_section_c = '%<%f %#Modified#%m%#StatusLine# %#_accent_red#%{airline#util#wrap(airline#parts#readonly(),0)}%#__restore__#'
